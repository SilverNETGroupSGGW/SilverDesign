...
Strona odpowiada w tej kolejności na trzy pytania czytelnika: *co tu będę
robić*, *czy dam radę*, *kiedy, gdzie i jak dołączyć*. Nic ponad to.

## 2. Zasady treści

1. Czas teraźniejszy. Koło istnieje i działa; historia, przerwy i
   „reaktywacja" nie są tematem. Jedyny ślad historii: linijka „przy WZIM
   SGGW od 2013" w stopce.
...
6. Nie wchodzi na stronę: hackathony z 2014, nazwiska z archiwów, oś czasu
   warsztatów, daty ostatnich aktualizacji aplikacji, liczba członków jako
   argument („rosnąca społeczność").
...
Jedna strona główna plus jedna podstrona, obie w PL i EN.
...
stack, linki), filtr *w sklepach / na GitHubie / wszystkie*.
